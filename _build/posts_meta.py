...
POSTS = [
    _p("ai-agents-for-med-spas", "ai", "bot", "med-spa-client-relaxing-robe",
       "Med spa client in a robe relaxing with tea before her treatment",
    ...
    _p("med-spa-seo-checklist", "growth", "search", "med-spa-facial-treatment",
       "Client relaxing with eyes closed during a facial treatment",
    ...
    _p("med-spa-software-integrations", "ops", "nodes", "med-spa-lounge-treatment-room",
       "Modern med spa lounge with treatment beds, plants, and relaxation chairs",
    ...
    _p("med-spa-missed-calls-no-shows", "ai", "phone", "spa-candle-ambiance",
       "Candle and greenery in a calm, softly lit spa setting",
    ...
    _p("med-spa-website-cost", "growth", "dollar", "spa-bathtub-palm-plant",
       "Minimalist spa bathroom with a freestanding stone tub and palm plant",
