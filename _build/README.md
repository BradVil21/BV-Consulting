...
python3 logos.py           # make logos in _build/src-logos/ transparent + compressed (for the carousel)
...
- `base.css`, `add.css`, `add2.css`, `add3.css`: combined into `/styles.css`
- `/sms-demo.js`: the interactive SMS phone demo (edit replies in the SERVICES, RULES, and SCENARIOS lists)
